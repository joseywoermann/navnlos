...
class Help(commands.Cog):
    ...
    async def help(self, ctx, arg = None):
        ...
        if arg == None:
            ...
            mod_help_embed.add_field(name="$kick <`@mention`>", value="Kicks a user.")
            mod_help_embed.add_field(name="$ban <`@mention`>", value="Bans a user.")
            mod_help_embed.add_field(name="$banid <`user-id`>", value="Bans a user by ID. With this, you can ban users that aren't even on the server.")
